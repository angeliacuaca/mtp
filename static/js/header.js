...
function isValidEmail() {
    ...
    if (re.test(strEmail)) {
        ...
        document.getElementById('spaceUser').innerHTML = "Incorrect Email Address";
...
function isValidPassword() {
    ...
    if (re.test(pwd)) {
        ...
        document.getElementById('spacePwd-first').style.color = "green";
    }
    else {
        document.getElementById('spacePwd-first').innerHTML = "Password must be at least 6 characters combination of at least one number, one lowercase and one uppercase letter"
        document.getElementById('spacePwd-first').style.color = "red";
    }
}
...
function reCheckpassword() {
    ...
    if (repwd == perpwd) {
        document.getElementById('spacePwd-second').innerHTML = "Passwords match";
        document.getElementById('spacePwd-second').style.color = "green";
    } else {
        document.getElementById('spacePwd-second').innerHTML = "Passwords don't match";
        document.getElementById('spacePwd-second').style.color = "red";
...
function isValidage() {
    ...
    if (reg.test(age)) {
        ...
        document.getElementById('birthday-age').innerHTML = "Please input numbers";
        document.getElementById('birthday-age').style.color = "red";
    }
}
